$(function () {
    ...
    $(document).ready(function (e) {
        ...
        var imageName = "home-bg-img-alt-" + rand + ".jpg";
        var imageUrl = "/images/" + imageName;
        $(".home-background").css("background", "url(" + imageUrl + ") no-repeat top center fixed");
        $(".home-background").css("background-size", "cover");
    ...
    var initLatitude = 45.39425; // <- Latitude here
    var initLongitude = 11.86560; // <- Longitude here
